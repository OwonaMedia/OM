      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12 text-black/70 font-light leading-relaxed">
          <section>
            ...
            <p>Für alle Geschäftsbeziehungen zwischen Owona Media (nachfolgend „Anbieter“) und dem Kunden gelten ausschließlich die nachfolgenden Allgemeinen Geschäftsbedingungen in ihrer zum Zeitpunkt der Bestellung gültigen Fassung.</p>
          </section>
