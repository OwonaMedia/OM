        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white border border-[#D4AF37]/30 rounded-2xl shadow-lg p-10 flex flex-col items-center text-center hover:shadow-2xl transition-all group">
            ...
            <div className="mt-auto">
              ...
              <button
                className="px-6 py-2 rounded bg-[#D4AF37] text-white font-semibold uppercase tracking-widest text-xs hover:bg-black hover:text-[#D4AF37] border border-[#D4AF37] transition"
                onClick={() => { addToCart('abo-basic'); navigate('/cart'); }}
              >
                {t('shop.addToCart')}
              </button>
            </div>
          ...
          <div className="bg-white border border-[#D4AF37]/30 rounded-2xl shadow-lg p-10 flex flex-col items-center text-center hover:shadow-2xl transition-all group">
            ...
            <div className="mt-auto">
              ...
              <button
                className="px-6 py-2 rounded bg-[#D4AF37] text-white font-semibold uppercase tracking-widest text-xs hover:bg-black hover:text-[#D4AF37] border border-[#D4AF37] transition"
                onClick={() => { addToCart('abo-pro'); navigate('/cart'); }}
              >
                {t('shop.addToCart')}
              </button>
            </div>
          ...
          <div className="bg-white border border-[#D4AF37]/30 rounded-2xl shadow-lg p-10 flex flex-col items-center text-center hover:shadow-2xl transition-all group">
            ...
            <div className="mt-auto">
              ...
              <button
                className="px-6 py-2 rounded bg-[#D4AF37] text-white font-semibold uppercase tracking-widest text-xs hover:bg-black hover:text-[#D4AF37] border border-[#D4AF37] transition"
                onClick={() => { addToCart('abo-full'); navigate('/cart'); }}
              >
                {t('shop.addToCart')}
              </button>
            </div>
