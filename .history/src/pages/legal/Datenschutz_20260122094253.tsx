...
export default function Datenschutz() {
  ...
  useEffect(() => {
    fetchHaendlerbundText('datenschutz')
      .then(async (deText) => {
        if (i18n.language === 'de') {
          setText(deText);
          setIsMachineTranslated(false);
        } else {
          const cached = getCachedTranslation('datenschutz', i18n.language);
          if (cached) {
            setText(cached);
          ...
          try {
            ...
            setText(translated);
            setIsMachineTranslated(true);
            setCachedTranslation('datenschutz', i18n.language, translated);
          } catch {
            setText(deText);
            setIsMachineTranslated(false);
          }
      ...
      .catch(() => setError('Fehler beim Laden der Datenschutzerklärung.'));
