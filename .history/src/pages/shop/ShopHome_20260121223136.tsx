    ...
    <div className="max-w-6xl mx-auto py-16 px-4">
      ...
      <div className="mt-16 flex justify-center">
        <div className="w-full">
          {/* TrustBox widget - Review Collector */}
          <div className="trustpilot-widget" data-locale="en-US" data-template-id="56278e9abfbbba0bdcd568bc" data-businessunit-id="676ea09d81011505a3a1132f" data-style-height="52px" data-style-width="100%" data-token="f4b75476-f7d3-47ab-a4e6-20c0b2263102">
            <a href="https://www.trustpilot.com/review/g1suic-cu.myshopify.com" target="_blank" rel="noopener">Trustpilot</a>
          </div>
          {/* End TrustBox widget */}
        </div>
      </div>
