    ...
    <div className="max-w-6xl mx-auto py-16 px-4">
      ...
      <div className="mt-16 flex justify-center">
        <div className="w-full">
          {/* TrustBox widget - Review Collector */}
          <div className="trustpilot-widget" data-locale="en-US" data-template-id="56278e9abfbbba0bdcd568bc" data-businessunit-id="6971cd57e8331ef9eedcb9ea" data-style-height="52px" data-style-width="100%" data-token="34e4af9f-fcff-41f2-bc20-d41a0737eb32">
            <a href="https://www.trustpilot.com/review/owona.de" target="_blank" rel="noopener">Trustpilot</a>
          </div>
          {/* End TrustBox widget */}
        </div>
      </div>
